...
DOMINION_REFRESH_NAME = "refreshDominion"
LOTR_REFRESH_NAME = "refreshLotr"
# Initialize app ----------------------------------------------------------------------------------------------
...
def _dominion_send_socketio_refresh(game_data, player_triggering_update, update_type):
  player_names = game_data["playerOrder"]
  _send_socketio_refresh(DOMINION_REFRESH_NAME, player_names, game_data,
...
def _send_socketio_refresh(refresh_name, player_names, game_data, player_triggering_update, update_type):
  socketio.emit(refresh_name,
                {"players": player_names,
                 "playerTriggeringUpdate": player_triggering_update,
...
def create_dominion_game():
  ...
  _dominion_send_socketio_refresh(game_data, username, "create")
...
def dominion_mutate_game():
  ...
  game_data = dominion.mutate_game(game_id, mutations)
  _dominion_send_socketio_refresh(game_data, username, "mutate")
  return ""
